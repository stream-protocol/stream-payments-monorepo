...
type Config struct {
	DataSource     string `yaml:"data_source" env:"DB_DATA_SOURCE" env-description:"Postgres connection string. Example: 'host=localhost sslmode=disable dbname=streampayment user=streampayment password=qwerty pool_max_conns=32'"`
